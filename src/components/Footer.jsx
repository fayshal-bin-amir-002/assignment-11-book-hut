    ...
    return (
        <div>
            <footer className="text-white bg-[#141E46] px-4 py-5 md:px-8">
                ...
                <ul className="flex justify-center flex-wrap  mt-8 gap-4 sm:flex sm:space-x-4 sm:space-y-0">
                    {
                ...
                <div className="mt-4 lg:mt-8 items-center lg:flex-row flex-col-reverse justify-between flex gap-4">
                    <div className="mt-4 sm:mt-0">
                        &copy; 2024 <span>Book <span className="text-[#41B06E]">Hut</span></span> || All rights reserved.
                    </div>
